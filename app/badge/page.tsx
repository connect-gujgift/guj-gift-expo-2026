...
function BadgeContent() {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center font-black text-[10px] text-slate-400 uppercase tracking-widest">Finalizing Design...</div>

  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center py-10 px-4 print:p-0 print:bg-white font-sans">
      
      {/* STANDARD DIMENSIONS: 4 x 5.5 INCH SCALE */}
      <div 
        ref={badgeRef}
        className="w-[380px] h-[550px] bg-white rounded-[2.5rem] shadow-2xl overflow-hidden relative flex flex-col print:shadow-none print:rounded-none border-[8px] border-white"
      >
        
        {/* HEADER: LARGER EVENT LOGO */}
        ...
        {/* UPDATED FOOTER: ALIGNED ORGANIZER LOGO */}
        <div className="bg-white p-6 pt-4 border-t border-slate-100">
           <div className="flex justify-between items-center w-full mb-4 px-2">
              <div className="text-left">
                <p className="text-[7px] font-bold uppercase tracking-widest text-slate-400 mb-0.5">Date</p>
                <p className="text-[10px] font-black text-[#0b3d41]">12-14 Aug 2026</p>
              </div>
              <div className="text-right">
                <p className="text-[7px] font-bold uppercase tracking-widest text-slate-400 mb-0.5">Venue</p>
                <p className="text-[10px] font-black text-[#0b3d41]">GMDC Ground, Ahmedabad</p>
              </div>
           </div>
           
           {/* CENTERED ORGANIZER SECTION */}
           <div className="flex flex-col items-center border-t border-slate-50 pt-4 w-full">
              <p className="text-[6px] font-bold text-slate-300 uppercase tracking-[0.4em] mb-2">Organized By</p>
              <img src="/organizer-logo.png" className="h-8 object-contain mb-2" />
      ...
      <div className="mt-8 flex flex-col gap-3 w-full max-w-[380px] print:hidden">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <Button onClick={() => alert('Emailing Pass...')} variant="outline" className="h-12 rounded-xl border-2 font-black uppercase text-[9px] tracking-widest">
            Send Email 📧
          </Button>
        </div>
      </div>
